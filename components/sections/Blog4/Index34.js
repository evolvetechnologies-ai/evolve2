...
export default function Index34(){
    return (
        <>
  ...
  <div className="text-center px-md-5 px-2 py-5 " style={{ backgroundColor: '#ffffff' }}>
    ...
    <h3 className="pt-4" style={{ color: 'rgb(32, 32, 32)', fontWeight: 300, textAlign: 'start' }}>
        Efficient combustion begins at the particle level.
In coal-fired boilers, uneven particle size distribution silently drives up fuel costs, emissions, and maintenance.


Evolve Technologies’ kinetic-energy-based segregation and primary air control (maintaining minimum coal temperature at 80°C) offers a novel, data-driven way to balance coal fineness in real time — improving reliability and combustion efficiency.


Even small changes in particle temperature and dynamics can lead to measurable improvements in plant heat rate, fuel consumption, and emission compliance.
  ...
  {/* section2 */}
  <div className="row text-center px-md-5 px-2 py-5 " style={{ backgroundColor: '#ffffff' }}>
    <div className="col-12 col-md-12 ">
      <h2 className="pt-3 mobile-fonts-heading text-start" style={{ fontSize: 50, fontWeight: 600, lineHeight: '75px' }}>
        Why Particle Size Segregation Matters:

      </h2>
      <h3 className="pt-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 300, textAlign: 'start' }}>Effective segregation management transforms combustion from a reactive process into a controlled science.


Evolve Technologies’ system leverages airflow physics — not additional hardware — to influence how pulverized coal particles segregate within transport lines.
By fine-tuning kinetic energy in the primary air, the system achieves a controlled balance between coarse and fine fractions before combustion — ensuring more uniform, efficient, and cleaner flame behavior.
...
With CFMS, coal mass flow, velocity and temperature are measured continuously, and any imbalance can be adjusted with adjustable coal flow balancing valves. The CFMS technology supersedes a traditional coagulation of fixed orifices, replacing it with dynamic control that reacts in real time with changing operating conditions.
  ...
  <div className="px-md-5 px-2 py-3">
    <h3 className="pt-4 fs-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>Why is CFMS Important?

    </h3>

   <ul>
    <li className="fs-4 pt-4" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>
  ...
  <div className="px-md-5 px-2 py-3">
    <h3 className="pt-4 fs-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>How Does CFMS Work ?


    </h3>

    <h3 className="pt-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 300, textAlign: 'start' }}>
  ...
  <div className="px-md-5 px-2 py-3">
    <h3 className="pt-4 fs-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>Case Study: DSPM Korba, Chhattisgarh
    ...
    <h3 className="pt-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 300, textAlign: 'start' }}>
        CSPGCL’s DSPM 250 MW unit in Korba demonstrated, first hand, the CFMS, where they use their dynamic Coal Flow Monitoring and Manipulation Systems.
          ...
          <h3 className="fs-4 pt-4" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>
...
Key Outcomes:
   ...
   <div className="px-md-5 px-2 py-3">
    <h3 className="pt-4 fs-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>Challenges in Coal Flow Balancing
...
<h3 className="pt-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 300, textAlign: 'start' }}>
   ...
   <ul>
    ...
    <h3 className="pt-4 fs-2" style={{ color: 'rgb(32, 32, 32)', fontWeight: 700, textAlign: 'start' }}>
